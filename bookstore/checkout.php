...
<?php
	echo '<h2 style="color: #000;">Order Successful waiting for payment...</h2>';
...
<img style="position:absolute; bottom:-330px; left:500px;" src="image/dsimg.png">
<h3 style="color:red; #011; position:absolute; bottom:-120px; left:470px">Pay through any UPI app...</h3>;
